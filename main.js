//|━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━|
//| Creator : Fmemore Can. (penata ulang)
//| Developer : C?
...
/*prefix = `#`*/
botname = 'Bot Cen' //ganti jdu name bot Lu:v
blocked = []
fakereply = '© Can.' //jan di ganti lah, hormati yang buat!!
fake = 'Can.' //ganti serah lu
...
client.on('group-participants-update', async (anu) => {
	...
	teks = `Haii👋@${num.split('@')[0]}\nSelamat datang di group *${mdata.subject}* Have A Nice Day`
...
//dah la males error
  ...
  msg = JSON.parse(JSON.stringify(msg)).messages[0]
   ...
   const ownerNumber = ["6285156760338@s.whatsapp.net","6283102650464@s.whatsapp.net"]
...
switch(command) {
            ...
            case 'developer':
                 ...
                 /*client.sendMessage(from, {displayname: "Jeff", vcard1: vcard}, MessageType.contact, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: {"contactMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "title": fakereply, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./blank.png')}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})*/
                  client.sendMessage(from, 'Ditunggu Kritik Dan Sarannya!', text, { quoted: msg, contextInfo: { forwardingScore: 508, isForwarded: true}} )
					break
            case 'help':
            case 'menu':
            case 'bantuan':
            ...
            case 'randomhentong':
					client.sendMessage(from,'donasi yuk biar kami dapat segera update', text, {quoted: ftroli, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    break
...
client.sendMessage('6285156760338@s.whatsapp.net',`*INFO DARI PENGGUNA*\n*Bug Report:* ${teks}`, text)
break
case 'request':
if (args.length < 1) return reply(`Ketik ${prefix}request [fiturnya] [RequestApa]`) 
teks = args.join(' ')
reply('Terima Kasih Telah Request Fitur Baru Pada Owner, Have A Nice Day!')
